      ...
      <div className="page"><div className="container-sm">
        <div className="tracking-success">
          ...
          <p className="text-muted" style={{ fontSize: '0.875rem' }}>
            You can track your complaint status using this number at any time.
          </p>
        </div>

        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          <button
            onClick={() => navigate(`/track?ref=${submitted}`)}
        ...
        <div className="card-body">
          <form onSubmit={submit}>
            ...
            <div className="alert alert-info">
              <span>ℹ️</span>
              <span>
                Your name and contact information from your account will be associated with this complaint for follow-up purposes.
              </span>
            </div>
